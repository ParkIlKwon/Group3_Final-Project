...
//내비게이션 메뉴 선택에 따라 변동된는 topMenu(sidebar)를 위한 컨트롤러
    ...
    /*private boolean isButtonActive = true; // 사이드메뉴 active 체크를 위한 변수*/
